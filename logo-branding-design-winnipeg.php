...
<main>
    ...
    <section id="branding" class="section">
        <div class="max-width">
            ...
            <p>
                A strong brand isn’t just a logo. It’s how you’re recognized in a split second, how you stand apart from competitors,
                and how you signal to customers that yes—you’re the real deal. Rocket Science Designs helps small businesses,
                startups, and growing brands in Winnipeg, Manitoba, and across Canada look sharp, consistent, and memorable
                without the big-agency attitude or mystery pricing.
            </p>

            <h2>Why Branding Matters</h2>
            <p>
                Your logo is your handshake, and consistency is the quickest path to looking professional. Recognition drives
                conversion, and in a market where you’re competing with both local and national players, polished branding gives
                you an edge.
            </p>

            <h2>What Rocket Science Designs Offers</h2>
            <p>
                A full identity system grounded in clarity, strategy, and good taste.
                You get thoughtful, well-executed visuals that scale with your business—no filler, no gimmicks.
            </p>

            <ul>
                <li>Custom logo concepts and refinements</li>
                <li>Colour palette and typography systems</li>
                <li>Iconography and supporting visual elements</li>
                <li>Brand voice guidelines and messaging tone</li>
                <li>Social media and digital content templates</li>
                <li>Business card and stationary design</li>
                <li>Comprehensive brand guidelines PDF</li>
                <li>Final assets delivered in all essential formats</li>
            </ul>

            <h2>The Process</h2>

            <h3>1. Discovery &amp; Positioning</h3>
            <p>
                We map out your story, audience, competitors, and goals—everything most businesses skip but shouldn’t.
            </p>

            <h3>2. Logo &amp; Visual Exploration</h3>
            <p>
                From sketches to polished concepts, we refine a visual identity that’s modern, intentional, and built to last.
            </p>

            <h3>3. Voice &amp; Messaging</h3>
            <p>
                Your visuals and words should feel like they belong together. We define tone, phrasing, and personality so your
                brand communicates clearly and consistently.
            </p>

            <h3>4. Asset Build-Out</h3>
            <p>
                Social templates, icons, business cards, headers—real-world tools you can use immediately.
            </p>

            <h3>5. Brand Guide &amp; Rollout</h3>
            <p>
                You receive an easy-to-follow guidelines document that ensures consistency across future designers, developers,
                employees, and campaigns.
            </p>

            <h2>Who This Is For</h2>
            <p>
                This service is ideal for small businesses, startups, established brands needing a refresh, and Winnipeg-based
                companies who want authenticity without sacrificing professional polish.
            </p>

            <h2>Why Work With Rocket Science Designs?</h2>
            <p>
                With multidisciplinary experience across design, development, and marketing, you get a cohesive brand system—not
                scattered visuals. Communication is clear, the process is lean, and the end result is something you can proudly
                use and maintain. Local insight ensures your brand fits Winnipeg’s market while still feeling at home nationally.
            </p>

            <h2>Ready to Get Started?</h2>
            <p>
                Reach out and I’ll send a short brand questionnaire to kick things off. From there, we’ll connect and map out
                exactly what your business needs—no fluff, no pressure, just a smart identity built to last.
            </p>
