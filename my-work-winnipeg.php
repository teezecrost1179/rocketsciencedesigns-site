...
$portfolioItems = [
  ...
  ['slug'=>'portfolio-photo-aabatteries','title'=>'AA Batteries Product Photography','category'=>'Photography and Photo Enhancement','thumbnail'=>'portfolio/portfolio-photo-aabatteries-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-photo-aabatteries.jpg','description'=>'Crisp product photo used in digital and print.'],
  ...
  ['slug'=>'portfolio-web-rocketreception','title'=>'Rocket Reception Website','category'=>'Web Design and Development','thumbnail'=>'portfolio/portfolio-web-rocketreception-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-web-rocketreception.jpg','description'=>'Single-page marketing site for <a href="https://rocketreception.ca">rocketreception.ca</a>, an AI project I\'ve been building. Site is focused on converting visitors, with clear CTAs.'],
  ['slug'=>'portfolio-web-wpgbeauty','title'=>'WPG Beauty Demo Website','category'=>'Web Design and Development','thumbnail'=>'portfolio/portfolio-web-wpgbeauty-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-web-wpgbeauty.jpg','description'=>'A "fake" website for a fictional local beauty brand. This site was built to showcase some of the contact features of Rocket Reception, an AI project I\'ve been working on.'],
  ...
  ['slug'=>'portfolio-graphics-whatitisbanner','title'=>'ADB What It Is Banner','category'=>'Graphic Design and Illustration','thumbnail'=>'portfolio/portfolio-graphics-whatitisbanner-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-graphics-whatitisbanner.jpg','description'=>'An educational banner for in-store display for the Adulting Done Bright prodct.'],
  ...
  ['slug'=>'portfolio-graphics-adblogo','title'=>'Adulting Done Bright Logo','category'=>'Graphic Design and Illustration','thumbnail'=>'portfolio/portfolio-graphics-adblogo-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-graphics-adblogo.jpg','description'=>'Primary logo design for Adulting Done Bright with a clean, energetic feel suited for digital and packaging use.'],
  ['slug'=>'portfolio-graphics-parenitylogo','title'=>'Parenity Logo','category'=>'Graphic Design and Illustration','thumbnail'=>'portfolio/portfolio-graphics-parenitylogo-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-graphics-parenitylogo.jpg','description'=>'Brand mark exploration and refinement for Parenity, balancing wellness and modern simplicity.'],
  ['slug'=>'portfolio-graphics-rocketlogo26','title'=>'Rocket Science Logo (2026)','category'=>'Graphic Design and Illustration','thumbnail'=>'portfolio/portfolio-graphics-rocketlogo26-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-graphics-rocketlogo26.jpg','description'=>'A slightly updated and upgraded treatment for the Rocket Science Designs logo — clean, minimal, and tech-forward.'],
  ['slug'=>'portfolio-graphics-rocketlogo','title'=>'Rocket Science Logo (2016)','category'=>'Graphic Design and Illustration','thumbnail'=>'portfolio/portfolio-graphics-rocketlogo-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-graphics-rocketlogo.jpg','description'=>'Original branding concept for Rocket Science Designs — clean, minimal, and tech-forward.'],
