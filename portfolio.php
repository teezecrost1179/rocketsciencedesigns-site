...
$portfolioItems = [
  ...
  ['slug'=>'portfolio-graphics-energypdf','title'=>'Energy PDF Design','category'=>'Graphic Design and Illustration','thumbnail'=>'portfolio/portfolio-graphics-energypdf-thumb.jpg','video'=>'','image'=>'portfolio/portfolio-graphics-whatitisbanner.jpg','description'=>'An educational banner for in-store use for the Adulting Done Bright product.'],
  ...
  <div class="container">
    <?php
      ...
      foreach ($categoryOrder as $category) {
        ...
        echo "<h2 style='margin-top:3rem;' id='$id'>$category</h2>";
        echo "<div class='grid'>";
        ...
        foreach ($grouped[$category] as $item) {
          ...
          echo "<div>";
          echo "<img src='{$item['thumbnail']}' alt='{$item['title']}' style='width:100%; border-radius:8px; cursor:pointer;' class='portfolio-thumb' data-title=\"{$dataTitle}\" data-description=\"{$dataDescription}\" data-src=\"{$dataSrc}\" data-type=\"{$dataType}\" />";
