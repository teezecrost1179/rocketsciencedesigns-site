...
<main>
    ...
    <section id="shopify" class="section">
        <div class="max-width">
            ...
            <p>
                Shopify is powerful, but that doesn’t mean it’s simple. Themes break, apps fight with each other,
                product data gets messy, and your “quick update” turns into a two-hour rabbit hole. At Rocket Science Designs,
                I help Winnipeg and Canadian brands get their Shopify stores set up, optimized, organized and working
                smoothly—whether you’re starting from scratch or you just need someone who knows what they’re doing.
            </p>

            <h2>What I can help with</h2>
            <p>
                From full store builds to small-but-important tweaks, I handle the design, configuration and technical details
                so you can focus on the business itself. Clean builds, clean code, clean management.
            </p>

            <ul>
                <li>Theme setup, customization and polishing</li>
                <li>Product setup, variants, collections and tagging systems</li>
                <li>Homepage and landing page design (built for conversion)</li>
                <li>Shopify OS2.0 sections, blocks and dynamic content setups</li>
                <li>App recommendations, installation and troubleshooting</li>
                <li>Store navigation, filtering and improved UX</li>
                <li>Shipping, taxes and payment configuration</li>
                <li>Custom Liquid edits for non-standard needs</li>
                <li>Speed and performance considerations</li>
                <li>Basic marketing integrations (email, pixels, analytics)</li>
            </ul>

            <h2>Full Shopify setups</h2>
            <p>
                For new stores, I can take you from zero to launch: theme selection, design, product entry, structuring
                collections, building key pages, configuring backend settings, and making sure your store actually works the way
                you want it to. You’ll get a store that looks professional, feels intuitive, loads quickly and is easy to manage.
            </p>

            <h2>Shopify fixes & small mods</h2>
            <p>
                Sometimes you don’t need a whole rebuild—you just need <em>that one thing</em> fixed.  
                A theme tweak. A product grid issue. A banner that won’t behave. A styling glitch.  
                I can jump in, make the adjustments, and get your store functioning properly again.
            </p>

            <h2>Product management & organization</h2>
            <p>
                A messy product catalogue hurts conversions and confuses customers. I help with clean, structured product setup:
                variants, SKUs, metafields, sizing tables, filters, custom labels—whatever your store needs to stay organized and
                easy to manage long-term.
            </p>

            <h2>Who this is for</h2>
            <p>
                Shopify stores in Winnipeg and across Canada that want expert-level setup, upgrades or fixes—without hiring an agency, 
                and without relying on apps for things that should be solved with proper design and development.
            </p>

            <h2>Why work with Rocket Science Designs?</h2>
            <p>
                You get a designer/developer who understands Shopify from both the technical and the business side.  
                I’ve managed products, customized themes, optimized flows and handled real-day-to-day store maintenance.  
                Communication is clear, the work is clean, and you’ll always know what’s happening behind the scenes.
            </p>

            <h2>Ready to get your Shopify store in shape?</h2>
            <p>
                Reach out—I'll send a quick intake form to understand what you need.  
                Then we’ll map out the smartest, cleanest way forward.
            </p>
